		...
		for i in xrange(0,self.numMatrix):
			for j in xrange(0,i):
				...
				for k in xrange(0,self.numMatrix):
					if k == 0:
						m=k
						#print("allMatrix[" + str(i) +"][" + str(self.numMatrix-1-m)+"] = temporal[" + str(i)+ "][" + str(m)+ "]")
						#print(str(allMatrix[i][self.numMatrix-1-m]) + " = " + str(temporal[i][m]))
						allMatrix[i][self.numMatrix-1-m] = temporal[i][m]
					else:
						m=self.numMatrix-k
						#print("allMatrix[" + str(i) +"][" + str(self.numMatrix-1-k)+"] = temporal[" + str(i)+ "][" + str(m)+ "]")
						#print(str(allMatrix[i][self.numMatrix-1-m]) + " = " + str(temporal[i][m]))
		...
		for i in xrange(0,self.numMatrix):
			for j in xrange(0,i):
				...
				for k in xrange(0,self.numMatrix):
					if k == 0:
						m=k
						#print("BallMatrix[" + str(self.numMatrix-1-m) +"][" + str(i)+"] = temporal[" + str(m)+ "][" + str(i)+ "]")
						#print(str(BallMatrix[self.numMatrix-1-m][i]) + " = " + str(temporal[m][i]))
